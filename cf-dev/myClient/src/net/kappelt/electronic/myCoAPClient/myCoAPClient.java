 ...
 ******************************************************************************/
package net.kappelt.electronic.myCoAPClient;
...
public class myCoAPClient {
	...
	private static final String SERVER_URI = "coaps://192.168.2.65/15001";
	...
	public myCoAPClient() {
		try {
			...
			builder.setPskStore(new StaticPskStore("Client_identity", "xxxx".getBytes()));
	...
	public static void main(String[] args) throws InterruptedException {
		...
		synchronized (myCoAPClient.class) {
			myCoAPClient.class.wait();
		}
	}
}
